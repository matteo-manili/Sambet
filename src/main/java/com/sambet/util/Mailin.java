...
public class Mailin extends ApplicationUtils {
	...
	public static void main(String[] args) {
        ...
        // da qui ottengo i parametri SMTP (nome utente, password e porta) da utilizzare come già faccio con smtp2.sambet.it e smtp.gmail.com
		...
		data.put("to", to);
		data.put("from", new String [] {ApplicationMessagesUtil.DammiMessageSource("email.info.sambet", null),"ApolloTransfert"});
