...
public class ApiNGDemo {
    ...
    static {
        try {
             ...
             File file = new File( loader.getResource( "keys/apingdemo.properties" ).getPath() );
             FileInputStream in = new FileInputStream( file );
        	
            //InputStream in = ApiNGDemo.class.getResourceAsStream("keys/apingdemo.properties");
            prop.load(in);
            in.close();
    ...
    public static void main(String[] args) throws APINGException {
        ...
        if(jsonRpcRequest) {
            ApiNGJsonRpc jsonRpcDemo = new ApiNGJsonRpc();
